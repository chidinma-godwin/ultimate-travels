  ...
  return (
    <React.Fragment>
      ...
      {props.flightData.map(flight => {
        ...
        let inboundTime = flight.itineraries[1].duration.slice(2).split("H");
...
export default FlightReturnList;
